...
from django.contrib.auth import views as auth_view  # for log in
...
if settings.DEBUG:
    urlpatterns += static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) # to make image url work with browser
